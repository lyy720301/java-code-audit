...
/**
 * Fastjson 1.2.42 版本的反序列化漏洞
 * <br>
 * 两个条件：
 * <br>
 1. fastjson.parser.autoTypeSupport 需要在fastjson.properties中配置为true （开启autotype）
 <p>
 2. 类名前加 L 类名后加 ; 就可以了，需要描述符双写，即分别加两个。
 </p>

 <p>
 与上个版本区别：
 黑名单以hash形式呈现，类进行判断，如果首尾含L;，则进行去除。
 </p>
 <p>
 黑名单列表 <a href="https://github.com/LeadroyaL/fastjson-blacklist">fastjson-blacklist</a>
 </p>
 *
 **/
public class PoC3_1_2_42 {
